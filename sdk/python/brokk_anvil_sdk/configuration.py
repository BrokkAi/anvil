...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "http://127.0.0.1:26845" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("brokk_anvil_sdk")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "http://127.0.0.1:26845",
                'description': "Default loopback listener. The bound address is reported on the daemon's stdout `serve.ready` line.",
            }
        ]
