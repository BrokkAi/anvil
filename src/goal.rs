...
/// is [`anvil_client::llm_client::is_retryable_llm_error`], applied in
...
/// base schedule is the codex-compatible [`anvil_client::http_retry::retry_backoff`]
...
pub(crate) fn goal_failure_backoff(consecutive_failures: u32) -> Duration {
    anvil_client::http_retry::retry_backoff(u64::from(consecutive_failures))
