...
fn must_allow_text_grep(pattern: &str, glob: &str, path: &str, file_path: &str) -> bool {
    ...
    if filename_or_resource_regex(pattern) || inline_regex_flag_text_search(pattern) {
        return true;
    }
    matches!(
