...
use anvil_client::structured_output::StructuredOutputResult;
...
pub struct CompactionCheckpoint {
    pub messages: Vec<anvil_client::llm_client::ChatMessage>,
    pub current_plan: Option<crate::plan::UpdatePlanArgs>,
}
...
pub struct Session {
    ...
    /// usage on disk yet.
    pub usage: anvil_client::llm_client::TokenUsage,
...
impl SessionUsageCost {
    fn record(&mut self, usage: anvil_client::llm_client::TokenUsage, delta_usd: Option<f64>) {
...
impl Session {
    ...
    fn new_with_sandbox_mode(
        ...
        Self {
            ...
            usage: anvil_client::llm_client::TokenUsage::default(),
...
impl SessionStore {
    ...
    pub async fn record_usage(
        &self,
        id: &str,
        delta: anvil_client::llm_client::TokenUsage,
        cost_delta_usd: Option<f64>,
    ) -> Option<anvil_client::llm_client::TokenUsage> {
        let mut sessions = self.sessions.write().await;
        let session = sessions.get_mut(id)?;
...
"#,
    ...
    async fn compaction_checkpoint_round_trips_without_replacing_raw_turn() {
        ...
        let checkpoint = CompactionCheckpoint {
            messages: vec![anvil_client::llm_client::ChatMessage::user(
