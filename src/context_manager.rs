...
mod tests {
    ...
    fn exact_tail_keeps_tool_call_and_result_together() {
        use anvil_client::llm_client::{FunctionCall, ToolCall};
    ...
    type CapturedCompactionRequest = (
        Vec<ChatMessage>,
        Option<Vec<anvil_client::llm_client::ToolDefinition>>,
    );
    ...
    fn read_file_tool_definition() -> anvil_client::llm_client::ToolDefinition {
        anvil_client::llm_client::ToolDefinition {
            r#type: "function".to_string(),
            function: anvil_client::llm_client::FunctionDef {
