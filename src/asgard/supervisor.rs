...
mod tests {
    ...
    fn supervisor_supplement_requires_numbered_ambiguity_resolutions() {
        ...
        assert!(supplement.contains("Portfolio option:"));
        assert!(supplement.contains("COMPLETE solution under a different resolution"));
        assert!(supplement.contains("judge the rival candidates with evidence, not preference"));
        assert!(
