...
use anvil_client::llm_client::{ModelMetadata, ReasoningLevelPreset};
...
use anvil_client::llm_client::{LlmBackend, LlmResponse, StreamChatRequest, TokenUsage};
use anvil_client::multi_backend::BackendRegistration;
                ...
                if call_index == 0 {
                    async move {
                        Ok(LlmResponse::ToolCalls {
                            text: String::new(),
                            reasoning_content: None,
                            calls: vec![anvil_client::llm_client::ToolCall {
                                id: "call-1".to_string(),
