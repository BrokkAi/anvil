...
- **Clippy suppressions**: do not add `#[allow(clippy::too_many_arguments)]` to get around linting. Prefer grouping related parameters into a request/context struct or splitting responsibilities so the function signature communicates intent.
