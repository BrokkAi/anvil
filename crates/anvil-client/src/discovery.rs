...
//! Xiaomi MiMo Token Plan and pay-as-you-go APIs, and OpenRouter
...
//! configures them.
//! Xiaomi MiMo's plans are enabled by dedicated environment variables (or
//! prefix-disambiguated `MIMO_API_KEY`) and deliberately target separate
//! subscription and pay-as-you-go endpoints.
//!
...
//! `kimi::k3`, `openai::deca/model-id`, `mimo::mimo-v2.6-pro`,
//! `mimo-payg::mimo-v2.6-pro`, and `openrouter::anthropic/claude-3.5-sonnet`.
...
impl ModelSource {
    ...
    pub const MIMO_PAYG: &'static str = "mimo-payg";
