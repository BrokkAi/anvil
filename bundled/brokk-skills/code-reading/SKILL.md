...
description: >-
  ...
  get_symbol_sources, get_summaries, and get_file_contents
  tools.
---
...
- Start with `get_summaries` when you need API shape, adjacent types, or package-level
...
- Use `get_summaries` when you need a quick declaration-level file outline across a glob.
